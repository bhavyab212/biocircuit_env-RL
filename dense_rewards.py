...
TASK_CONFIGS: dict[int, TaskCheckpointConfig] = {
    1 : TaskCheckpointConfig(1,  "Basic Expression",
                             target_fluorescence=1.0, optimal_part_count=3,
                             preferred_promoter_strength="medium"),
    2 : TaskCheckpointConfig(2,  "NOT Gate (Simple)",
                             requires_operator=True, requires_repressor=True,
                             target_fluorescence=0.0, optimal_part_count=5),
    3 : TaskCheckpointConfig(3,  "Inducible Expression",
                             requires_operator=True, requires_repressor=True,
                             requires_inducer=True,
                             target_fluorescence=1.0, optimal_part_count=5),
    4 : TaskCheckpointConfig(4,  "Activated Expression",
                             requires_cap=True,
                             target_fluorescence=1.0, optimal_part_count=4),
    5 : TaskCheckpointConfig(5,  "NOT Gate (Advanced / LacI Steric)",
                             requires_operator=True, requires_repressor=True,
                             target_fluorescence=0.0, optimal_part_count=5,
                             preferred_promoter_strength="medium"),
    6 : TaskCheckpointConfig(6,  "Two-Gene Circuit",
                             requires_polycistronic=False,
                             target_fluorescence=1.0, optimal_part_count=6),
    7 : TaskCheckpointConfig(7,  "Weak Promoter Optimisation",
                             target_fluorescence=0.2, optimal_part_count=3,
                             preferred_promoter_strength="weak"),
    8 : TaskCheckpointConfig(8,  "Repression Network",
                             requires_operator=True, requires_repressor=True,
                             target_fluorescence=0.0, optimal_part_count=6),
    9 : TaskCheckpointConfig(9,  "Dual-Input Gate (AND/NOT)",
                             requires_operator=True, requires_repressor=True,
                             target_fluorescence=0.5, optimal_part_count=7),
    10: TaskCheckpointConfig(10, "Drug-Inducible Circuit",
                             requires_operator=True, requires_repressor=True,
                             requires_inducer=True,
                             target_fluorescence=1.0, optimal_part_count=5),
    11: TaskCheckpointConfig(11, "CAP Activation",
                             requires_cap=True,
                             target_fluorescence=1.0, optimal_part_count=4,
                             preferred_promoter_strength="weak"),
    12: TaskCheckpointConfig(12, "CAP-Lac Dual Regulation",
                             requires_operator=True, requires_repressor=True,
                             requires_cap=True, requires_inducer=True,
                             target_fluorescence=1.0, optimal_part_count=7),
    13: TaskCheckpointConfig(13, "Enhancer Loop",
                             requires_enhancer=True,
                             target_fluorescence=1.0, optimal_part_count=4),
    14: TaskCheckpointConfig(14, "Polycistronic Design",
                             requires_polycistronic=True,
                             target_fluorescence=1.0, optimal_part_count=5),
    15: TaskCheckpointConfig(15, "Signal Cascade",
                             requires_operator=True, requires_repressor=True,
                             requires_cap=True, requires_inducer=True,
                             requires_enhancer=True,
                             target_fluorescence=1.0, optimal_part_count=9),
}
